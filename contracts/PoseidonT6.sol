  ...
  function hash(uint[5] memory inputs) public pure returns (uint) {
    assembly {
      ...
      function round(c0, c1, c2, c3, c4) {
        ...
        mstore(0x100, addmod(mload(0xe0), mload(0x100), F))
...

      {
        ...
        let state1 := addmod(mload(0x80), 0x0ab7b291388e5c9e43c0dc1f591fb83ecdb65022e1b70af43b8a7b40c1dff7c3, F)
        let state2 := addmod(mload(0xa0), 0x2b7cbb217896f52c9a8c088e654af21e84cde754a3cef5b15c4d5466612d6adf, F)
        let state3 := addmod(mload(0xc0), 0x2bc6b0ddbe1d701b6570428bdc1ca1bf0da59ff3bbbb95fc2bc71c0c6e67a65c, F)
        let state4 := addmod(mload(0xe0), 0x123a55a31980384f3d20b2cecbc44ed60c38c11f7d20e9271efab9a905eefd3c, F)
        mstore(0x120, addmod(mload(0x120), 0x1c2116e47e03a86bb11695b0a5f6dab6b9a460b1eb951ab01c259eca3fd47d51, F))
        mstore(0x100, addmod(mload(0x100), 0x037501cc8c9dc819309a769f4df098e588b01858bc8eb7e279e2883be9fb8c53, F))
        ...
        p := mload(0x100)
        p := mulmod(p, p, F)
        mstore(0x100, mulmod(mulmod(p, p, F), mload(0x100), F))

        // state0 pow5mod and M[] multiplications are pre-calculated

        p := addmod(
          addmod(addmod(0x1c75a58d854d4821d299acc8b5bf528d82545baa1fccd11b4af481536dd42d76, mulmod(state1, M10, F), F), mulmod(state2, M20, F), F),
          mulmod(state3, M30, F),
          F
        )
        mstore(0x0, addmod(addmod(mulmod(state4, M40, F), mulmod(mload(0x100), M50, F), F), p, F))
        p := addmod(
          addmod(addmod(0x2c64e4fd7d22b7941e97b236fac1a6979275c4dbb22f9707238fb478316e73d9, mulmod(state1, M11, F), F), mulmod(state2, M21, F), F),
          mulmod(state3, M31, F),
          F
        )
        mstore(0x20, addmod(addmod(mulmod(state4, M41, F), mulmod(mload(0x100), M51, F), F), p, F))
        p := addmod(
          addmod(addmod(0x213c4e421d44e697cd674a6d377a752d9bc2ebf497165ce792643bf39fc034f7, mulmod(state1, M12, F), F), mulmod(state2, M22, F), F),
          mulmod(state3, M32, F),
          F
        )
        mstore(0x80, addmod(addmod(mulmod(state4, M42, F), mulmod(mload(0x100), M52, F), F), p, F))
        p := addmod(
          addmod(addmod(0x2435ad434d1117db1f271503cd65ce1c5c2ac1900e1cd74ae1c6e490593a934, mulmod(state1, M13, F), F), mulmod(state2, M23, F), F),
          mulmod(state3, M33, F),
          F
        )
        mstore(0xa0, addmod(addmod(mulmod(state4, M43, F), mulmod(mload(0x100), M53, F), F), p, F))
        p := addmod(
          addmod(addmod(0x36a710abf9f57bb09aa288687ad8dcbcb9dc74c200d89d83d8e3c41f28e6b2e, mulmod(state1, M14, F), F), mulmod(state2, M24, F), F),
          mulmod(state3, M34, F),
          F
        )
        mstore(0xc0, addmod(addmod(mulmod(state4, M44, F), mulmod(mload(0x100), M54, F), F), p, F))
        p := addmod(
          addmod(addmod(0x201541d8be11e6a050f6aea51e645577db6ab8ed6d672de377d108c0fc4dad04, mulmod(state1, M15, F), F), mulmod(state2, M25, F), F),
          mulmod(state3, M35, F),
          F
        )
        mstore(0xe0, addmod(addmod(mulmod(state4, M45, F), mulmod(mload(0x100), M55, F), F), p, F))
      mstore(0x100, 0x0e970c19d19748d8c465104d8f02200363f9a41786f02f1827742b20dc0d1727)
      ...
      mstore(0x100, 0x0816be42745b7dbb4ceffe5b8e24ea60fd8b719deba50037ac7b75948745c6bc)
      ...
      mstore(0x100, 0x2636e0973c865c1bd974dd78daaa8d0a84cdaf6be1ad47ecf2a0d18f117318f2)
      ...
      mstore(0x100, 0x0e1eca5df88ee5f60cfa7e1fe5befbb719fad8211fa9b2d02fcc233190c17f12)
      ...
      mstore(0x100, 0x03a35aa3123911cdb4535baed3359f5f6a5205b9c93ef31d35323a47807b8bc9)
      ...
      mstore(0x100, 0x180b11b720622a156849dc6f7f6e7f571659be69682230c5ed9ac339700a7cde)
      ...
      mstore(0x100, 0x2350bf35477656899151ad7dde96ea7857e15501447008dab6b3d27c8ffa274f)
      ...
      mstore(0x100, 0x241dcc51ac37808a415dd1e3c281f05aff11789dc0cafdd77a35484e0993f9a4)
      ...
      mstore(0x100, 0x188c926255f5b7af3da96355729c2a8670ab4c2c70400481b2ac903740e0c5ab)
      ...
      mstore(0x100, 0x233031847b476bead0118d3db338e89133ec420d673e504ad647259df655571e)
      ...
      mstore(0x100, 0x217bef2f4f12c6dcc91c2058a23391cb77de53ca6e44dcdc6ea3d36fea326ea6)
      ...
      mstore(0x100, 0x226bac7050166e5f6db78cd0b12d36f305b6e8c9a055114ad7709e6f57245b6b)
      ...
      mstore(0x100, 0x1980077457995712c44da7e17713258e3f8eb354bfd80ed9eaf3ecbaf6960105)
      ...
      mstore(0x100, 0x1f93a532917394c7e22fd17abeea6389c66fd7ae2dd9f02f860f6d96947f0edd)
      ...
      mstore(0x100, 0x277c4de2363d8b5b456cfc5a7ff8e46ff2ec8daa59855f5ad64bc0521f3ac567)
      ...
      mstore(0x100, 0x2667349978401362f6b17939eeb0e64ff55607ebdb35c7071db46bb3e7ba4778)
      ...
      mstore(0x100, 0x2bcb0b0db8b9e3e02b7e9c1c9460fdd9c6cd98562332e648d8a3e0ab94597520)
      ...
      mstore(0x100, 0x2683b425e85a508f96852f14b4220fcfe9f7ad8b17bfefc0e348c47ca78bb57f)
      ...
      mstore(0x100, 0x282b37020c0890d751c3fd76950d8068668e1dfeae621dd552d2de887da2ea75)
      ...
      mstore(0x100, 0x0ab4773f150c3f8ad3bc9538f43cec395a7e3731ae973fefeb623a09217e64c7)
      ...
      mstore(0x100, 0x2d9e32a7c90556fe108d255ac01e75df338fcd63b2bf84c19280d427298863fc)
      ...
      {
        let state0 := addmod(mload(0x0), 0x29a322a84c25bd2ddf6e2e4200228d95abd6349a02266ac1dbba520738ceca97, F)
        let state1 := addmod(mload(0x20), 0x0678c9bfc6f2df012f4fe55e33bb68ac14ced1df0d02152792089d046d828c43, F)
        let state2 := addmod(mload(0x80), 0x0faff3a5e7425794fe20a7e0eb615b8b1760394b7f2304286a3ae4009124db23, F)
        let state3 := addmod(mload(0xa0), 0x1f8f5b611af9feb9cea86c084058120553e404103aee213f5a41d1d02541c0d3, F)
        let state4 := addmod(mload(0xc0), 0x160875d8479602f96f40acc2d042ee52c1588b6a29de4284965a6dc6c930ea07, F)
        mstore(0x100, addmod(mload(0xe0), 0x16d87a5183a316a1d70afc951efe2cd667c77328fcfda458cbf5fe3045f46d9e, F))
